...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0, 0, 0,12.25);
    ...
    public static double GEAR_RATIO = 2.14365872; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 35.75; // in
    ...
    public static double MAX_ANG_VEL = Math.toRadians(233.6394613159258);
