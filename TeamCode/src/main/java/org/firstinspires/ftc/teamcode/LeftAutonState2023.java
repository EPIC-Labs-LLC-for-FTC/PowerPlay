...
@Autonomous(name = "Left Auton State 2023",group = "Competition")
public class LeftAutonState2023 extends LinearOpMode {
//    OpenCvCamera webcam;
//    Scanner scanner;
...
//        //distance = 6.0;
        ...
        rightBackDistance = ds.getRightBackDistance();
//
        leftBackDistance = 33.5-leftBackDistance;
        rightBackDistance = 33.5-rightBackDistance;
//        //forward
...
//        //turret.alignPole();
        ...
        arm.doTransition();
        sleep(servoSleep);
        outtakeSlide.set(2800,motorSleepS);
        //sleep(1500);
        outtake.drop();
        sleep(servoSleep);
        outtake.recieve();
        ...
        //arm.doLevel2();
            if(parkingSpot==3)
                    distance = 32;
            wheels.encoderDrive(0.8,distance,distance,distance,distance,2);
